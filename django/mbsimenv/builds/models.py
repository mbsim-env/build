...
class Repos(django.db.models.Model):
  ...
  repoName=AL(django.db.models.CharField(max_length=50), L.inline, L.list, L.search)
  branch=django.db.models.CharField(max_length=50)
  ...
  updateCommitID=django.db.models.CharField(max_length=50)
