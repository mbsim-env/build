...
"$SCRIPTDIR"/mbsbd "$MBSIMENVDIR"/build/django/mbsimenv/runexamples.py --buildType linux64-docker --executor '<span class="MBSIMENV_EXECUTOR_LOCALDOCKER">Local Docker</span>' "$@"
